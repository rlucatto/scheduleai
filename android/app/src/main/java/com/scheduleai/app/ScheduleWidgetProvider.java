...
public class ScheduleWidgetProvider extends AppWidgetProvider {
    ...
    private void updateWidget(final Context context, final AppWidgetManager appWidgetManager, final int appWidgetId) {
        ...
        views.setTextViewText(R.id.txt_status, "v2.3 - ... (Atualizando)");
            ...
            public void run() {
                try {
                    ...
                    if (data != null && !data.startsWith("ERROR: ")) {
                        ...
                        views.setTextViewText(R.id.txt_status, "v2.3 - Atualizado às " + sdf.format(new Date()));
                    } else {
                        ...
                        views.setTextViewText(R.id.txt_status, "v2.3 - " + errMsg);
                    }
                    appWidgetManager.updateAppWidget(appWidgetId, views);
                } catch (Throwable e) {
                    e.printStackTrace();
                    ...
                    hideAllEventRows(views);
                    views.setTextViewText(R.id.txt_status, "v2.3 - Erro: " + (e.getMessage() != null ? e.getMessage() : "Erro desconhecido"));
                    appWidgetManager.updateAppWidget(appWidgetId, views);
                } finally {
